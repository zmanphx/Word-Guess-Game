  ...
  var game = {
    ...
    {     var blankstr;
          ...
          for(var i=0; i<str.length;i++) {
            if (fullword[i]===checkLetter)  blankstr = replaceA(blankstr, i, checkLetter); //indices.push[i];

      }        
      return blankstr
    },

  // replace charater at postion. 
...
,
  ...
  guessWordSoFar = game.makeblank();  // This is the blank word with spaces
